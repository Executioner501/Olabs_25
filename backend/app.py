...
def explain():  
    ...
    Explain why the correct answer is right in simple terms.give the answer point wise and keep it concise so that a normal student can understand it well restrict the answer to max 3 points"""
